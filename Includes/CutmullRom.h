...
void DrawCatmullRom (array_t <stt, vect_t, 4> & points, char radiusMouse, COLORREF colorDrawing);
void DrawCatmullRom (vect_t point0, vect_t point1, vect_t point2, vect_t point3,
                     char radiusMouse, COLORREF colorDrawing);
...
void DrawCatmullRom (array_t <stt, vect_t, 4> & points, char radiusMouse, COLORREF colorDrawing)
    ...
    const int amountPixels = std::max ((int) (abs (points[2].x - points[1].x)), (int) (abs (points[2].y - points[1].y))) + 1;
...
void DrawCatmullRom (vect_t point0, vect_t point1, vect_t point2, vect_t point3,
    ...
    DrawCatmullRom (points, radiusMouse, colorDrawing);
    }
